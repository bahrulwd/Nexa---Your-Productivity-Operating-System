          ...
          <div className="relative z-10 flex flex-col h-full justify-between">
            ...
            <div className="my-auto py-4">
              <h1 className="font-display font-extrabold text-[28px] leading-[36px] text-white mb-3 tracking-tight leading-tight">
                Master your workload. <br />
                <span className="text-[#fec886]">Focus on what matters.</span>
              </h1>
              <p className="font-sans text-[14px] leading-[22px] text-white/70 leading-relaxed font-medium">
                Nexa uses Smart Priority Scoring to help you conquer your day without the burnout.
              </p>
            </div>

            {/* Illustration Tablet Interface with visual styling improvements - height reduced */}
        ...
        <section className="md:w-1/2 bg-white p-8 md:p-10 flex flex-col justify-center">
          <div className="w-full max-w-sm mx-auto">
            <header className="mb-6">
              <h2 className="font-display font-black text-[26px] leading-[32px] text-[#15113d] mb-1">Welcome back</h2>
              <p className="font-sans text-[13px] font-bold text-[#9CA3AF]">Please enter your details to sign in.</p>
            </header>

            {error && (
              <div className="mb-5 p-3.5 bg-red-500/10 border border-red-500/20 rounded-2xl text-xs font-bold text-red-500 animate-fade-in flex items-center gap-2">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-2.5 py-2.5 px-4 border border-[#F3F4F6] rounded-xl font-sans font-bold text-[13px] text-[#15113d] hover:bg-[#F8F9FB] hover:border-gray-200 shadow-sm transition-all duration-200 active:scale-[0.98] cursor-pointer disabled:opacity-50"
            >
              <img
                alt="Google G Logo"
            ...
            <form onSubmit={handleLogin} className="space-y-4.5">
              ...
              <div className="space-y-1 focus-within:translate-y-[-1px] transition-transform duration-200">
                ...
                <input
                  ...
                  id="email"
                  type="email"
                  placeholder="bahrul@students.unnes.ac.id"
                  value={email}
              ...
              <div className="space-y-1 focus-within:translate-y-[-1px] transition-transform duration-200">
                <div className="flex justify-between items-center">
                  <label className="font-sans font-bold text-[12.5px] text-[#15113d]" htmlFor="password">Password</label>
                  <a className="font-sans font-bold text-[12.5px] text-[#7C3AED] hover:underline" href="#">Forgot password?</a>
                </div>
              ...
              <div className="flex items-center gap-2">
                <input
                  className="w-3.5 h-3.5 rounded border-[#F3F4F6] text-[#7C3AED] focus:ring-[#7C3AED] cursor-pointer accent-[#7C3AED]"
                  id="remember"
                  type="checkbox"
                />
                <label className="font-sans font-bold text-[12.5px] text-[#9CA3AF] cursor-pointer select-none" htmlFor="remember">
              ...
              {/* Sign In button */}
              <button
                className="w-full py-2.5 bg-gradient-to-r from-[#7C3AED] to-[#6C5DD3] text-white font-display font-bold text-[15px] rounded-xl hover:from-[#6B32CD] hover:to-[#5B4EBE] transition-all duration-300 shadow-md shadow-[#7C3AED]/15 hover:shadow-[#7C3AED]/30 active:scale-95 duration-100 cursor-pointer disabled:opacity-50"
                type="submit"
                disabled={loading}
              >
            ...
            <footer className="mt-6 text-center">
              <p className="font-sans text-[13.5px] font-bold text-[#9CA3AF]">
                ...
                <Link className="font-sans font-bold text-[#7C3AED] hover:underline ml-1" to="/register">
                  Sign up
                </Link>
              </p>
            </footer>
